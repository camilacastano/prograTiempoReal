...
// while ((turnos < 9))
{
    ...
    if ((tablero[position[1, 0], position[1, 1]] == tablero[position[5, 0], position[5, 1]]) && (tablero[position[1, 0], position[1, 1]] == tablero[position[9, 0], position[9, 1]]) && (tablero[position[1, 0], position[1, 1]] != "-"))
    {
        System.Console.WriteLine("Ganó diagonal 1");
        winner = true;
        break;
    }

    if ((tablero[position[7, 0], position[7, 1]] == tablero[position[5, 0], position[5, 1]]) && (tablero[position[7, 0], position[7, 1]] == tablero[position[3, 0], position[3, 1]]) && (tablero[position[7, 0], position[7, 1]] != "-"))
    {
        System.Console.WriteLine("Ganó diagonal 2");
        winner = true;
        break;
    }
